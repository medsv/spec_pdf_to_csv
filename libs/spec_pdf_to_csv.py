...
def parse_spec(doc):
    ...
    if spec == []: raise ValueError("В файле спецификация не найдена")    
    return spec
...
def detect_pattern(line):
    ...
    for i, col in enumerate(line):
        if col == '' or col is None: continue
        pattern.append(i)
    return pattern
...
#spec_pdf_to_csv("./test_data/P5054.40-1.1-ВК2-Rev1.pdf")
#spec_pdf_to_csv("./test_data/2411-ПИР-ИЛО-ТР6=0_2026.07.07.pdf")
